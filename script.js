...
// let vowel = "а, о,и, ы, у, э"
// function checkTasc(str) {
//   return str.length
// }
// console.log(checkTasc("достопримечательность"));
...
//? Задание № 12
// Напишите функцию, которая принимает массив с числами и выводит количество отрицательных
...
// function checkTasc(arr) {
//   let newArr = arr.filter((el) => el < 0);
//   return newArr.length;
// }
// console.log(checkTasc(arr));
...
//? Задание № 15
// Напишите функцию, которая принимает в качестве параметров два целых числа и возвращает значение
// true (истина), если в числах одинаковое количество цифр; иначе функция возвращает значение false (ложь).
// Пример: func(2398, 19)
// Вывод: false
